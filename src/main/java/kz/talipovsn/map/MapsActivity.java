...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.297134, 76.946992); // Начальный маркер
    ...
    static final LatLng marker1 = new LatLng(52.297299, 76.951430);//Барыс
    static final LatLng marker6 = new LatLng(52.298345, 76.954556);//ПГПУ
    static final LatLng marker5 = new LatLng(52.296027, 76.945672);//МузКолледж
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.baris)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.musiccol)).alpha(ALPHA).
